 ...
 * @author Author
 */
public class CrystalBoarDefinition {
	public static final AnimationDefinition boar_attack = AnimationDefinition.Builder.withLength(3.0F).looping()
	...
	public static final AnimationDefinition boar_idle = AnimationDefinition.Builder.withLength(1.0F).looping()
		.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
